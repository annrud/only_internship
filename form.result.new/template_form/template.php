    ...
    <div class="input<?=in_array($arQuestion['STRUCTURE'][0]['FIELD_TYPE'], ['text', 'email']) ? ' contact-form__input' : ''?>">
        <label class="input__label">
            ...
            <?if(in_array($arQuestion['STRUCTURE'][0]['FIELD_TYPE'], ['text', 'email'])):?>
                <input type="<?=$arQuestion['STRUCTURE'][0]['FIELD_TYPE']?>" class="input__input" name="form_text_<?=$arQuestion['STRUCTURE'][0]['FIELD_ID']?>" value="<?=$arQuestion['STRUCTURE'][0]['VALUE']?>"/>
            <?endif;?>
            <?if($arQuestion['STRUCTURE'][0]['FIELD_TYPE'] === 'textarea'):?>
                <textarea class="input__input" name="form_textarea_<?=$arQuestion['STRUCTURE'][0]['FIELD_ID']?>"><?=$arQuestion['STRUCTURE'][0]['VALUE']?></textarea>
            <?endif;?>
